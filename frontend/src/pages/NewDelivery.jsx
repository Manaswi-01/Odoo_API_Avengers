...
const NewDelivery = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            type: 'Delivery', // Explicitly set type
            lines: validLines.map(l => ({
                productId: l.productId,
                qty: parseInt(l.qty),
                locationFrom: formData.defaultLocation || undefined // Use default location as source
            }))
        };
        ...
        <div className="min-h-screen bg-[var(--bg-primary)]">
            ...
            <div className="container-main section-spacing">
                <div className="page-header">
                    ...
                    <p className="page-description">Process outbound shipments and orders</p>
                </div>
                        ...
                        {formData.warehouseId && (
                            <div>
                                ...
                                <p className="text-xs text-[var(--text-tertiary)] mt-1">
                                    Where items are picked from (defaults to warehouse logic if empty)
                                </p>
                            </div>
                        )}
